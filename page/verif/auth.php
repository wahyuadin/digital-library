...
try {
    ...
    //Recipients
    $mail->setFrom('finalproject@kelompok-1.com', 'Fathurahman');
    ...
    $mail->Body    = 'Untuk melanjutkan login, berikut adalah link verifikasi <b>'.'http://localhost/fatur/page/verif.php?p='.$row['param'].'</b>';
