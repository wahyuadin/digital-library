    ...
    <body>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <marquee behavior="scroll" class="btn btn-dark">Selamat Datang <b><?= $_SESSION['login']['nama']; ?></b> dashboard admin aplikasi perpustakaan.</marquee>
                    ...
                    ?>
                       ...
                       <form action="user.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="">NIM</label>
                            <input type="text" name="nim" id="tgl_kembali" class="form-control" placeholder="Masukan NIM" required>
                        </div>
                        <div class="form-group">
                            <label for="">Tempat Lahir</label>
                            <input type="text" name="tempat" id="tgl_kembali" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="prodi" id="tgl_kembali" class="form-control" placeholder="Masukan Nama Prodi" required>
                        </div>
